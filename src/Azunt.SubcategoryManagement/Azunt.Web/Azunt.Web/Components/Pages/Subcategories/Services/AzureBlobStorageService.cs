...
{
    public class AzureBlobStorageService : ISubcategoryStorageService
    {
        private readonly BlobContainerClient _containerClient;
        private readonly string _subFolder;

        public AzureBlobStorageService(IConfiguration config, string subFolder = "subcategories")
        {
        ...
        public async Task<Stream> DownloadAsync(string fileName)
        {
            ...
            if (!await blobClient.ExistsAsync())
                throw new FileNotFoundException($"Subcategory file not found: {fileName}");
